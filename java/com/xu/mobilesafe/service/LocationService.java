...
public class LocationService extends Service {
	...
	//服务监听位置只需要触发一次，所以在oncreate里面写就可以了
	@Override
	public void onCreate() {
		...
		criteria.setAccuracy(Criteria.ACCURACY_FINE);//指定获取经纬度的精确度（差不多就可以了）
		//返回true时候，就对应某一个方法去提供对应的经纬度坐标
