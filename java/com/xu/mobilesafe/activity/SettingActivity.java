...
import com.xu.mobilesafe.service.AddressService;
import com.xu.mobilesafe.service.BlackNumberService;
import com.xu.mobilesafe.service.WatchDogService;
import com.xu.mobilesafe.utils.ConstantValue;
import com.xu.mobilesafe.utils.ServiceUtil;
import com.xu.mobilesafe.utils.SpUtil;
import com.xu.mobilesafe.view.SettingClickView;
...
public class SettingActivity extends Activity {
	...
	private void initAppLock() {
		...
		boolean isRunning = ServiceUtil.isRunning(this, "com.xu.mobilesafe.service.WatchDogService");
	...
	private void initBlacknumber() {
		...
		//判断这个服务是否在运行的服务
		boolean isRunning = ServiceUtil.isRunning(this, " com.xu.mobilesafe.service.BlackNumberService");
		//判断这个服务是否在运行的服务
	...
	private void initToastStyle() {
		...
		//2,SP获取吐司显示样式的索引值(int),用于归属地文字的获取描述文字，默认是0
	...
	protected void showToastStyleDialog() {
		//这里一定要传this不要传上下文，因为窗口是依赖activity存在的
	...
	private void initAddress() {
		...
		//对服务是否开的状态做显示
		//用serviceutil来判断com.xu.mobilesafe.service.AddressService服务是否开启
		boolean isRunning = ServiceUtil.isRunning(this, "com.xu.mobilesafe.service.AddressService");
